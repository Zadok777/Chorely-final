...
2. Tap this link on your device: **[TestFlight link]**
...
Use this quick form to send feedback: **[Feedback form link]**

It's an early beta, so a few rough edges are expected — your notes make it better. Thank you! 🙏

[Your name]
doulosnexus@gmail.com
...
3. Overall, how was your experience? [1–5 stars]
...
3. What screen were you on? [multiple choice: Home / Chores / Review / Family / More / Rewards / Sign in / Other]
4. What happened? [paragraph]
5. What did you expect to happen? [paragraph]
6. Steps to make it happen again: [paragraph] (e.g., "1. Tap Add chore 2. ...")
7. How often does it happen? [Always / Sometimes / Once]
8. Screenshot or screen recording (optional): [file upload]
9. How badly does it block you? [Minor / Annoying / Can't use the app]
...
3. What problem would it solve for your family? [paragraph]
4. How important is it to you? [Nice to have / Would really help / Must have]
5. Anything similar you've seen in another app? [short answer]
...
### Tip: keep a simple tracker
Make a Google Sheet with columns: **Date | Tester | Device | Type (bug/idea/praise) | Summary | Severity | Status (new/fixed/won't do)**. Paste form responses in and triage weekly.
